...
*   **User Content:** Photos of birds you capture/upload and Audio data (bird sounds). These are stored so you can build your personal bird collection.
*   **Identifiers:** A unique User ID assigned to your account.
*   **Purchase History:** Information regarding your monthly or yearly subscriptions to manage "Pro" features.
*   **Usage Data:** Information about how you interact with the app (e.g., button clicks, identification history).

### B. Anonymous Diagnostic Data
The following data is collected but is **not** linked to your identity:

*   **Crash Data:** Technical logs generated if the app crashes.
*   **Performance Data:** Information about app launch times and network latency.

## 2. How We Use Your Information
We use the collected data for:
*   **App Functionality:** To identify birds, save your sightings, and manage your account.
*   **Personalization:** To show you birds relevant to your geographic area.
*   **Analytics:** To monitor app performance and improve our bird identification engine.
